...
def main():
    ...
    np.save(f"{DEMNUnii.CACHE_DIR}/_lss_cls/cl_kk.npy", Cl_kk)
    np.save(f"{DEMNUnii.CACHE_DIR}/_lss_cls/cl_gk.npy", Cl_kg)
    np.save(f"{DEMNUnii.CACHE_DIR}/_lss_cls/cl_Ik.npy", Cl_kI)
