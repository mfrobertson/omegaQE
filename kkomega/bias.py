                ...
                for theta12 in thetas12:
                    ...
                    if w2 != 0:
                        for jjj, L3 in enumerate(Ls3):
                            ...
                            g_XY = self._qe.weight_function(XY, L3, L, thetas_L3)
                            g_YX = self._qe.weight_function(XY[::-1], L3, L, thetas_L3)
                        ...
                        I_A1_L1[iii] += L1 * np.sum(2 * dTheta12 * bi * InterpolatedUnivariateSpline(Ls3, I_A1_L3).integral(30, 4000))
                        I_C1_L1[iii] += L1 * np.sum(2 * dTheta12 * bi * InterpolatedUnivariateSpline(Ls3, I_C1_L3).integral(30, 4000))
                    ...
                    for theta12 in thetas12:
                        ...
                        if w2 != 0:
                            for jjj, L3 in enumerate(Ls3):
                                ...
                                L_C1_fac = L1_L3 * L2_L3
                                thetas_L3 = thetas13 - theta_1L
                                g_XY = self._qe.gmv_weight_function(XY, L3, L, thetas_L3)
                                g_YX = self._qe.gmv_weight_function(XY[::-1], L3, L, thetas_L3)
